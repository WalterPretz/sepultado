...
<br>
  <center>
  <h3 style="color: #03064A"><i class="fa fa-clipboard-list"></i> Listado de Comisiones</h3></center>
</header>
<br>
<section>
  <div class="table-responsive-sm">
    ...
    <thead class="imprimir-tabla"> 
      <tr>
        ...
        <th class="text-center">Comisión Asignado</th>
       ...
       <?php
         ...
         ?>
          ...
          <tr>
            ...
            <td class="text-center"><?php echo $a['comision'] ;?></td>
            <td class="text-center"><?php echo $a['descripcion2'] ;?></td>
          </tr>
         <?php
            }
          ?>
